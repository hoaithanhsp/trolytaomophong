...
import { Search, Sparkles, Settings, Monitor, Loader2, FlaskConical, Atom, Dna, Calculator, Check } from 'lucide-react';
import { SUBJECTS, GRADES, DEVICE_OPTIONS, SearchParams } from '../types';
